					...
					<div class="col-md-8 posts-col">
                        ...
                        <div class="block-21 d-flex animate-box post">
                            ...
                            <div class="meta">
                                ...
                                <div class="comments_count"><a href="{{route('posts.show',$post)}}#post_comments"><span class="icon-chat"></span> {{$post->comments_count}}</a></div>
                            </div>
                            </div>
                        </div>
                        @endforeach
...
{{--
                            ...
                            <x-blog.side-recent-posts :recent-posts ='$recent-posts'/>
